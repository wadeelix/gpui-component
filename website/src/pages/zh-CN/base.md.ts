...
// The tree's own index, served at `/zh-CN/base.md` — the address the published
// site uses, rather than the `/zh-CN/base/.md` an empty dynamic segment produces.
