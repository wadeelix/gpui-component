...
// The tree's own index, served at `/shell.md` — the address the published
// site uses, rather than the `/shell/.md` an empty dynamic segment produces.
export const GET: APIRoute = async () => {
  const entries = await getCollection('shell');
