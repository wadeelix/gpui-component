...
pub use gpui_base::input::{
    Backspace, BufferPoint, CodeActionItem, CodeActionProvider, ColumnAlign, CompletionMenuOptions,
    ...
    IndentInline, InlineWidget, InlineWidgetKind, InputContextMenuCapabilities, InputEdit,
    InputEvent, InputHighlighter, InputHighlighterFactory, InputState, LineDecoration, Lsp,
    MaskPattern, MoveDown, MoveEnd, MoveHome, MoveLeft, MovePageDown, MovePageUp, MoveRight,
    MoveToEnd, MoveToEndOfLine, MoveToNextWord, MoveToPreviousWord, MoveToStart, MoveToStartOfLine,
    MoveUp, NativeMenu, NativeMenuItem, Outdent, OutdentInline, Paste, Point, Redo, Replace, Rope,
